...
tmux send-keys "rosrun navio2_remote remote_multiCtr_Kalman_final 50 1600 0.7 0.2 0.2 46.51849177 6.56666458" C-m
...
tmux send-keys "rosrun navio2_imu imu_pub_drift_compensation 49" C-m
...
#log files, control algorithm
elif [ "$#" -eq 1 ] && [ "$1" == 'alllogcontrol' ]
then
echo "Here we go in auto mode and gps information (log recorded): freq= 50, MaxThrottlePwm=1600, Kp=0.7, Ki=0.2, Kd=0.2"
sleep 2
tmux -2 new-session -d -s $SESSION
...
tmux send-keys "source /home/pi/catkin_ws/devel/setup.bash" C-m
#tmux send-keys "rosrun navio2_remote remote_multiCtr 50 1600 0.7 0.2 0.2" C-m
tmux send-keys "rosrun navio2_remote remote_multiCtr_kalman_controller 50 1600 0.7 0.2 0.2 46.51849177 6.56666458" C-m

tmux split-window -v
tmux send-keys "sleep 5" C-m
tmux send-keys "source /home/pi/catkin_ws/devel/setup.bash" C-m
tmux send-keys "rosrun Navio2_controller mpc_controller" C-m
